let titulos_carousel = [];
let car_indicator = 0;
// OBTENGO LENGUAJE DE COOKIE GRACIAS A LINGUA
...
document.addEventListener("DOMContentLoaded", function() {
  /// CAMBIADO DE TITULOS DEL CAROUSEL DE LAS SECCIONES
  if (language == 'en'){
    titulos_carousel = ['Commercial section','Administration','Technical office','Aluminum Sector','PVC industry','Glass Sector','Logistics','Placement'];
  } else {
  ...
  document.getElementById('i-calidad').addEventListener('click',function(){
    if (language == 'en'){
      updateModal(
        ...
        "Our processes are continuously updated, in order to comply with the quality commitment of our products.",
  ...
  document.getElementById('i-trabajo').addEventListener('click',function(){
    if (language == 'en'){
      updateModal(
        ...
        "We come together as a team to ensure customer satisfaction. Our services add value to the product, respecting your wishes.",
  ...
  document.getElementById('i-profesional').addEventListener('click',function(){
    if (language == 'en'){
      updateModal(
        "Professionalism",
        "We are responsible towards the Environment and the society in which we are inserted, therefore we minimize our impact on the environment.",
  ...
  document.getElementById('i-cliente').addEventListener('click',function(){
    if (language == 'en'){
      updateModal(
        ...
        "Our products and services are oriented to fully satisfy your needs. From fasteners to cosmetic closures, we provide simple, yet effective solutions.",
  ...
  document.getElementById('i-responsabilidad').addEventListener('click',function(){
    if (language == 'en'){
      updateModal(
        ...
        "We take care that our operations are economically, socially and environmentally sustainable, recognizing the interests of the different groups with which we relate, seeking the preservation of the environment and the sustainability of future generations.",
  ...
  document.getElementById('i-planificacion').addEventListener('click',function(){
    if (language == 'en'){
      updateModal(
        "Careful planning and effective actions",
        "We analyze your project from start to finish, in order to be effective and efficient. The planning and execution of that planning distinguish us.",
